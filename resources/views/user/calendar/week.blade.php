    ...
    <section class="space-y-5">
            ...
            <div class="flex flex-wrap items-center gap-2.5">
                <div class="flex items-center dark:bg-white/[0.06] bg-black/[0.05] rounded-[10px] p-1 gap-1">
                    ...
                    <a href="{{ route('user.calendar.week') }}"
                        class="px-3 py-1.5 rounded-[8px] text-[13px] font-bold bg-gradient-to-r from-orange-500 to-pink-500 text-white">Week</a>
                    <a href="{{ route('user.calendar.day') }}"
                        class="px-3 py-1.5 rounded-[8px] text-[13px] font-bold dark:text-gray-400 text-gray-500 dark:hover:text-white hover:text-gray-900 transition-colors">Day</a>
        ...
        <div
            ...
            <div class="grid grid-cols-8 border-b dark:border-white/[0.07] border-black/[0.07]">
                <div class="py-3 px-2 text-[11px] font-bold dark:text-gray-600 text-gray-300 uppercase text-center">Time
                </div>
