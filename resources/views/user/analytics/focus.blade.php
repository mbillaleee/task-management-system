...
@section('user')
    <div class="space-y-6">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
            <div>
                <h2 class="text-[22px] font-extrabold dark:text-white text-gray-800"><i class="fas fa-clock"></i> Focus
                    Analytics</h2>
                <p class="text-[13px] dark:text-white text-gray-800 mt-0.5">Sessions, time tracked, XP earned and ambient
                    sounds.</p>
            </div>
            ...
            <div class="flex items-end gap-1 overflow-x-auto pb-2" style="height:130px">
                @foreach ($focusChart as $day)
                    ...
                    <div class="flex flex-col items-center flex-shrink-0 group relative"
                        ...
                        @endif
                        <div class="w-full rounded-t transition-all {{ $isToday ? 'bg-gradient-to-t from-blue-800 to-cyan-600' : 'dark:bg-blue-700/30 bg-blue-400' }}"
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div class="veroa-card shadow-[0_20px_60px_rgba(0,0,0,0.25)] rounded-2xl border p-5">
                ...
                @if ($bestDay)
                    ...
                    <p class="text-[12px] dark:text-white text-gray-800 mt-0.5">{{ round($bestDay->minutes / 60, 1) }}
                        hours of deep work</p>
                @else
                    <p class="text-[14px] dark:text-white text-gray-800">No completed sessions yet.</p>
                @endif
            </div>
            ...
            <div class="veroa-card shadow-[0_20px_60px_rgba(0,0,0,0.25)] rounded-2xl border p-5">
                ...
                <div class="space-y-3">
                    ...
                    @if ($soundBreakdown->isEmpty())
                        <p class="text-[13px] dark:text-white text-gray-800">No sessions yet.</p>
                    @endif
                </div>
            </div>
        </div>
