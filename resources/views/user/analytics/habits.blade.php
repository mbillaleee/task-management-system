...
@section('user')
    <div class="space-y-6">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
            <div>
                <h2 class="text-[22px] font-extrabold dark:text-white text-gray-900">🔥 Habit Analytics</h2>
                <p class="text-[13px] dark:text-gray-500 text-gray-400 mt-0.5">Streaks, completion rates and daily heatmap.
                </p>
            </div>
        ...
        <div class="dark:bg-[#17141f] bg-white rounded-2xl border dark:border-white/[0.07] border-black/[0.07] p-5">
            ...
            <div class="flex items-end gap-1 overflow-x-auto pb-2" style="height:100px">
                @foreach ($habitChart as $day)
                    <div class="flex flex-col items-center flex-shrink-0" style="min-width:{{ $period <= 14 ? '32px' : '10px' }}">
                        <div class="w-full rounded-t {{ $day['count'] > 0 ? 'bg-gradient-to-t from-orange-500 to-pink-400' : 'dark:bg-white/[0.05] bg-gray-100' }}"
        ...
        <div
            ...
            <div class="divide-y dark:divide-white/[0.05] divide-black/[0.04]">
                ...
                @empty
                    <div class="px-5 py-8 text-center text-[14px] dark:text-gray-500 text-gray-400">No active habits found.
                    </div>
                @endforelse
            </div>
        </div>
            ...
            <div class="flex flex-wrap gap-1">
                ...
                @for ($i = 89; $i >= 0; $i--)
                    ...
                    <div title="{{ $d }}: {{ $cnt }} completions"
                        class="w-3.5 h-3.5 rounded-sm cursor-default {{ $cnt === 0 ? 'dark:bg-white/[0.05] bg-gray-100' : '' }}"
