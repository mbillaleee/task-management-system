            ...
            <div class="xl:col-span-2 space-y-4">
                ...
                <div class="hover-lift veroa-card shadow-[0_20px_60px_rgba(0,0,0,0.25)] rounded-2xl p-[18px]">
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-3 mt-5">
                        <div class="dark:bg-white/[0.04] bg-gray-50 rounded-xl p-3">
                            <p class="text-[12px] dark:text-white text-gray-800"> <i class="fas fa-sync-alt mr-1"></i>
                                Frequency</p>
                            <p class="text-[13px] font-bold dark:text-white text-gray-800">{{ ucfirst($habit->frequency) }}
                            </p>
                        </div>
                        <div class="dark:bg-white/[0.04] bg-gray-50 rounded-xl p-3">
                            <p class="text-[12px] dark:text-white text-gray-800"> <i class="fas fa-info-circle mr-1"></i>
                                Status</p>
                        ...
                        <div class="dark:bg-white/[0.04] bg-gray-50 rounded-xl p-3">
                            <p class="text-[12px] dark:text-white text-gray-800"> <i class="fas fa-calendar-alt mr-1"></i>
                                Started</p>
                        ...
                        <div class="dark:bg-white/[0.04] bg-gray-50 rounded-xl p-3">
                            <p class="text-[12px] dark:text-white text-gray-800"> <i class="fas fa-chart-line mr-1"></i>
                                30-day Rate</p>
                ...
                <div class="hover-lift veroa-card shadow-[0_20px_60px_rgba(0,0,0,0.25)] rounded-2xl p-[18px]">
                    <div class="flex items-center justify-between mb-4">
                        ...
                        <div class="flex items-center gap-2 text-[11px] dark:text-white text-gray-800">
                                ...
                                <div class="flex flex-col gap-1">
                                    @foreach ($week as $date)
                                        @php
                                            ...
                                            $bg = $done ? 'bg-orange-800' : 'dark:bg-white/[0.06] bg-gray-400';
                                            $ring = $isToday
                    ...
                    <p class="text-[11px] dark:text-white text-gray-800 mt-2">
                ...
                <div class="hover-lift veroa-card shadow-[0_20px_60px_rgba(0,0,0,0.25)] rounded-2xl p-[18px]">
                    <h3 class="text-[15px] font-bold dark:text-white text-gray-900 mb-3.5">
                        ...
                        <span class="text-[12px] font-normal dark:text-white text-gray-800 ml-1">(last 30)</span>
                    </h3>
                    ...
                    <div class="space-y-2">
                        ...
                        @empty
                            <div
                                ...
                                <i class="fas fa-calendar-times text-2xl text-gray-800 dark:text-white mb-2 block"></i>
                                <p class="text-[12px] dark:text-white text-gray-800">No completions yet.</p>
                            </div>
                        @endforelse
                    </div>
                </div>
                ...
                <div class="hover-lift veroa-card shadow-[0_20px_60px_rgba(0,0,0,0.25)] rounded-2xl p-[18px]">
                    ...
                    <div class="space-y-3">
                        <div class="dark:bg-white/[0.04] bg-gray-50 rounded-xl p-4 text-center">
                            <p class="text-[12px] dark:text-white text-gray-800 mb-1"> <i class="fas fa-fire mr-1"></i>
                                Current Streak</p>
                            <h4 class="text-[36px] font-extrabold dark:text-white text-gray-900 leading-none">
                                {{ $habit->streak?->current_streak ?? 0 }}
                            </h4>
                            <p class="text-[12px] dark:text-white text-gray-800 mt-1">days</p>
                        </div>

                        <div class="dark:bg-white/[0.04] bg-gray-50 rounded-xl p-4 text-center">
                            <p class="text-[12px] dark:text-white text-gray-800 mb-1"> <i class="fas fa-trophy mr-1"></i>
                                Best Streak</p>
                        ...
                        <div class="dark:bg-white/[0.04] bg-gray-50 rounded-xl p-3">
                            <p class="text-[12px] dark:text-white text-gray-800"> <i class="fas fa-calendar-check mr-1"></i>
                                Last Completed</p>
                        ...
                        <div class="dark:bg-white/[0.04] bg-gray-50 rounded-xl p-3">
                            <p class="text-[12px] dark:text-white text-gray-800"> <i class="fas fa-check-circle mr-1"></i>
                                Total Completions</p>
                            <p class="text-[13px] font-bold dark:text-white text-gray-800 mt-1">
                                {{ $logs->count() }} times
                            </p>
                    ...
                    @if ($habit->reminder_enabled && $habit->remind_time)
                        <div class="flex items-center gap-2.5 dark:bg-orange-500/[0.08] bg-orange-50 rounded-xl p-3">
                            ...
                            <div>
                                ...
                                <p class="text-[11px] dark:text-white text-gray-800"> <i class="fas fa-sync-alt mr-1"></i>
                                    Every day</p>
                            </div>
                        </div>
                    @else
                            ...
                            @foreach (['mon' => 'Mon', 'tue' => 'Tue', 'wed' => 'Wed', 'thu' => 'Thu', 'fri' => 'Fri', 'sat' => 'Sat', 'sun' => 'Sun'] as $key => $label)
                                <span
                                    ...
                                    {{ in_array($key, $habit->days)
                                        ...
                                        : 'dark:bg-white/[0.06] bg-gray-100 dark:text-white text-gray-800' }}">
                                    {{ $label }}
                                </span>
                            @endforeach
                        </div>
