...
<div class="space-y-5">
    ...
    {{-- ─── Title ─────────────────────────────────────────────── --}}
    <div>
        <label class="block text-[12px] font-bold dark:text-white text-gray-800 mb-1.5">Habit Title</label>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div>
            <label class="block text-[12px] font-bold dark:text-white text-gray-800 mb-1.5">Frequency</label>
    ...
    <div id="weeklyDays" class="{{ old('frequency', $habit->frequency ?? 'daily') === 'weekly' ? '' : 'hidden' }}">
        <label class="block text-[12px] font-bold dark:text-white text-gray-800 mb-2">Repeat on Days</label>
    ...
    <div class="flex items-center justify-end gap-2 pt-3 border-t dark:border-white/[0.06] border-black/[0.05]">
        <a href="{{ route('user.habits.index') }}"
            ...
            dark:bg-white/[0.07] bg-gray-100 dark:text-white text-gray-800">
