                ...
                <div
                    ...
                    <div class="relative z-10 grid grid-cols-2 gap-3 mt-4">
                        <div class="dark:bg-white/[0.04] bg-gray-50 rounded-xl p-3">
                            <p class="text-[16px] dark:text-gray-500 text-gray-400">Current Streak</p>
                            <p class="text-[18px] font-bold dark:text-white text-gray-800">
                                {{ $habit->streak?->current_streak ?? 0 }} Days
                            </p>
                        </div>

                        <div class="dark:bg-white/[0.04] bg-gray-50 rounded-xl p-3">
                            <p class="text-[16px] dark:text-gray-500 text-gray-400">Best Streak</p>
                            <p class="text-[18px] font-bold dark:text-white text-gray-800">
