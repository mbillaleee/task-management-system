...
@section('user')
    <div class="space-y-5">
            ...
            <div class="relative z-10 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div>
                    ...
                    <p class="text-[15px] dark:text-gray-400 text-gray-600 mt-2">
                        <i class="fa-solid fa-info-circle"></i> Update your note. Changes will autosave while typing.
                    </p>
                </div>
        ...
        dark:text-gray-400 text-gray-500">
            <i class="fa-solid fa-save"></i> Autosave status:
            <span id="autosaveStatus" class="text-orange-400"> <i class="fa-solid fa-clock"></i> Waiting...</span>
        </div>
    </div>
