    ...
    <div class="space-y-5">
        ...
        <section
            ...
            <div class="flex flex-col xl:flex-row xl:items-center justify-between gap-4">
                ...
                <form method="GET" action="{{ route('user.note-categories.index') }}"
                    ...
                    transition-all duration-300">
                        ...
                        <div class="relative z-10">
                            ...
                            <div class="mt-4 flex items-center gap-2">
                                <span class="w-8 h-8 rounded-xl border border-white/10"
                            ...
                            <div
                                ...
                                <div class="flex items-center gap-2">
                                    ...
                                    <form action="{{ route('user.note-categories.destroy', $category) }}" method="POST">
                                        ...
                                        <button
                                            onclick="return confirm('Delete this category? Notes inside this category will not be deleted, only category relation will be removed.')"
                ...
                @empty
                    <div class="md:col-span-2 xl:col-span-3">
                        <div
                            ...
                            <p class="text-[14px] dark:text-gray-500 text-gray-500 mt-2">Create your first note category.
                            </p>
