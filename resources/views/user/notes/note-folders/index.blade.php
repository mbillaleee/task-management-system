...
<div class="space-y-5">
    ...
    <section
        ...
        <div class="flex flex-col xl:flex-row xl:items-center justify-between gap-4">
            ...
            <form method="GET" action="{{ route('user.note-folders.index') }}" class="flex flex-col md:flex-row gap-2.5 w-full xl:w-auto">
                        ...
                        <div class="flex items-center justify-between mt-5 pt-4 border-t dark:border-white/[0.06] border-black/[0.05]">
                            ...
                            <div class="flex items-center gap-2">
                                ...
                                <form action="{{ route('user.note-folders.destroy', $folder) }}" method="POST">
                                    ...
                                    <button onclick="return confirm('Delete this folder? Notes inside this folder will not be deleted, only folder relation will be removed.')"
...
<!-- Create Folder Modal -->
<div id="createFolderModal" class="fixed inset-0 z-[999] hidden items-center justify-center bg-black/70 backdrop-blur-sm px-4">
    <div class="w-full max-w-md rounded-2xl dark:bg-[#17141f] bg-white border dark:border-orange-500/[0.22] border-orange-200 p-5 shadow-[0_0_40px_rgba(249,115,22,.25)]">
        <div class="flex items-center justify-between mb-5">
            ...
            <button type="button" onclick="closeCreateFolderModal()" class="text-[24px] dark:text-gray-400 text-gray-500">×</button>
        </div>
...
<!-- Edit Folder Modal -->
<div id="editFolderModal" class="fixed inset-0 z-[999] hidden items-center justify-center bg-black/70 backdrop-blur-sm px-4">
    <div class="w-full max-w-md rounded-2xl dark:bg-[#17141f] bg-white border dark:border-orange-500/[0.22] border-orange-200 p-5 shadow-[0_0_40px_rgba(249,115,22,.25)]">
        <div class="flex items-center justify-between mb-5">
            <h3 class="text-[22px] font-extrabold dark:text-white text-gray-900">Update Folder</h3>
            <button type="button" onclick="closeEditFolderModal()" class="text-[24px] dark:text-gray-400 text-gray-500">×</button>
        </div>
