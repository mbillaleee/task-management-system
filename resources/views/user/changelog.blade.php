...
@section('user')
    <div class="space-y-6">
        ...
        <!-- Page Header -->
        <div class="relative overflow-hidden rounded-2xl border veroa-card px-6 py-7">
            ...
            <div class="relative z-10 flex flex-col lg:flex-row lg:items-center justify-between gap-5">
                <div>
                    ...
                    <h1
                        class="text-[28px] sm:text-[32px] md:text-[38px] font-extrabold leading-tight dark:text-white text-gray-800">
                        Changelog
                    </h1>

                    <p class="text-[14px] dark:text-white text-gray-800 mt-2 max-w-[520px] leading-[1.7]">
                ...
                border dark:border-white/[0.08] border-orange-200 shadow-[0_0_35px_rgba(249,115,22,.25)]">
                    <span class="text-[52px]"><i class="fa-solid fa-code-branch"></i></span>
                </div>
            </div>
        </div>
        ...
        <div class="grid grid-cols-2 lg:grid-cols-4 gap-3.5">
            ...
            <div class="hover-lift veroa-card rounded-2xl p-[18px]">
                <p class="text-[14px] font-semibold dark:text-white text-gray-800 mb-2">Total Updates</p>
            ...
            <div class="hover-lift veroa-card rounded-2xl p-[18px]">
                <p class="text-[14px] font-semibold dark:text-white text-gray-800 mb-2">New Features</p>
                <h3 class="text-[30px] font-extrabold text-pink-500">12</h3>
                <p class="text-[12px] text-pink-500 mt-1">Major additions</p>
            </div>

            <div class="hover-lift veroa-card rounded-2xl p-[18px]">
                <p class="text-[14px] font-semibold dark:text-white text-gray-800 mb-2">Fixes</p>
                <h3 class="text-[30px] font-extrabold text-emerald-500">8</h3>
                <p class="text-[12px] text-emerald-500 mt-1">Bug resolved</p>
            </div>

            <div class="hover-lift veroa-card rounded-2xl p-[18px]">
                <p class="text-[14px] font-semibold dark:text-white text-gray-800 mb-2">Current Version</p>
        ...
        <div
            ...
            veroa-card shadow-[0_20px_60px_rgba(0,0,0,0.25)] border
        rounded-2xl p-5">
                ...
                <div class="space-y-4">
                    @foreach ($changes as $change)
                        <div class="relative pl-12">
                            ...
                            <div class="hover-lift veroa-card
                            rounded-2xl p-5">

                                <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-2 mb-3">
                                    <div class="flex items-center gap-2 flex-wrap">
                                        <span class="text-[13px] font-extrabold dark:text-white text-gray-800">
                                            {{ $change['version'] }}
                                        </span>
                                    ...
                                    <span class="text-[11.5px] dark:text-white text-gray-800">
                                        {{ $change['date'] }}
                                    </span>
                                </div>

                                <h3 class="text-[15px] font-extrabold dark:text-white text-gray-800 mb-2">
                                    {{ $change['title'] }}
                                </h3>

                                <p class="text-[12.5px] leading-[1.7] dark:text-white text-gray-800 mb-4">
                                    {{ $change['desc'] }}
                                </p>
