...
@section('admin')
    <section class="space-y-6">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4">
            <div class="hover-lift veroa-card shadow-[0_20px_60px_rgba(0,0,0,0.25)] border rounded-2xl p-5">
                <p class="text-[14px] dark:text-white text-gray-800 font-bold"><i class="fas fa-users"></i> Total Users
                </p>
            ...
            <div class="hover-lift veroa-card shadow-[0_20px_60px_rgba(0,0,0,0.25)] border rounded-2xl p-5">
                <p class="text-[14px] dark:text-white text-gray-800 font-bold"><i class="fas fa-coins"></i> Total XP
                    Earned</p>
            ...
            <div class="hover-lift veroa-card shadow-[0_20px_60px_rgba(0,0,0,0.25)] border rounded-2xl p-5">
                <p class="text-[14px] dark:text-white text-gray-800 font-bold"><i class="fas fa-medal"></i> Badges Given
                </p>
            ...
            <div class="hover-lift veroa-card shadow-[0_20px_60px_rgba(0,0,0,0.25)] border rounded-2xl p-5">
                <p class="text-[14px] dark:text-white text-gray-800 font-bold"><i class="fas fa-tasks"></i> Challenges
                    Done</p>
        ...
        <div class="hover-lift veroa-card shadow-[0_20px_60px_rgba(0,0,0,0.25)] border rounded-2xl p-[18px]">
            ...
            <div class="space-y-3">
                @foreach ($topUsers as $i => $ug)
                    <div class="flex items-center gap-4 p-3 rounded-xl dark:bg-white/[0.04] bg-gray-50">
                        ...
                        {{ $i === 0 ? 'bg-yellow-400 text-yellow-900' : ($i === 1 ? 'bg-white text-gray-700' : ($i === 2 ? 'bg-orange-400 text-orange-900' : 'dark:bg-white/[0.08] bg-gray-200 dark:text-white text-gray-800')) }}">
                            {{ $i + 1 }}
                        </div>
                        ...
                        <div class="text-right">
                            ...
                            <p class="text-[12px] dark:text-white text-gray-800"><i class="fas fa-level-up-alt"></i>
                                Level {{ $ug->level }}</p>
                        </div>
                        ...
                        <div class="text-right hidden sm:block">
                            <p class="text-[14px] font-bold text-emerald-400"><i class="fas fa-fire"></i>
                                {{ $ug->streak_days }}</p>
                            <p class="text-[12px] dark:text-white text-gray-800"><i class="fas fa-clock"></i> Current
                                streak</p>
                        </div>
                    </div>
                @endforeach
        ...
        <div class="grid grid-cols-1 xl:grid-cols-2 gap-4">
            ...
            <div class="hover-lift veroa-card shadow-[0_20px_60px_rgba(0,0,0,0.25)] border rounded-2xl p-[18px]">
                <div class="flex items-center justify-between mb-4">
                    <h3 class="text-[18px] font-extrabold dark:text-white text-gray-800"><i class="fas fa-medal"></i> Recent
                        Badges</h3>
                    <a href="{{ route('admin.badges.index') }}"
                ...
                <div class="space-y-3">
                    @forelse($badges->take(5) as $badge)
                        <div class="flex items-center gap-3 p-3 rounded-xl dark:bg-white/[0.04] bg-gray-50">
                            ...
                            <div class="flex-1">
                                <p class="text-[14px] font-bold dark:text-white text-gray-800">{{ $badge->name }}</p>
                                <p class="text-[12px] dark:text-white text-gray-800">{{ $badge->xp_required }} XP
                                    required</p>
                            </div>
            ...
            <div class="hover-lift veroa-card shadow-[0_20px_60px_rgba(0,0,0,0.25)] border rounded-2xl p-[18px]">
                <div class="flex items-center justify-between mb-4">
                    <h3 class="text-[18px] font-extrabold dark:text-white text-gray-800"><i class="fas fa-tasks"></i> Recent
                        Challenges</h3>
                    <a href="{{ route('admin.challenges.index') }}"
                        class="text-[13px] font-bold text-orange-400 hover:underline"><i class="fas fa-eye"></i> View
                        all</a>
                    ...
                    @forelse($challenges->take(5) as $challenge)
                        <div class="p-3 rounded-xl dark:bg-white/[0.04] bg-gray-50">
                            <div class="flex items-center justify-between">
                                <p class="text-[14px] font-bold dark:text-white text-gray-800">{{ $challenge->title }}</p>
