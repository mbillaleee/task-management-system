...
<div>
    <label class="block text-[12px] font-bold dark:text-gray-300 text-gray-700 mb-1.5">Badge Name</label>
...
<div class="grid grid-cols-1 md:grid-cols-3 gap-4">
    ...
    <div>
        <label class="block text-[12px] font-bold dark:text-gray-300 text-gray-700 mb-1.5">Color</label>
    ...
    <div>
        <label class="block text-[12px] font-bold dark:text-gray-300 text-gray-700 mb-1.5">XP Required</label>
