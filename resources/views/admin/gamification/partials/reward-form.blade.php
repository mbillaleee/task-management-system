...
<div>
    <label class="block text-[12px] font-bold dark:text-white text-gray-800 mb-1.5">Day Number (1–7)</label>
...
<div>
    <label class="block text-[12px] font-bold dark:text-white text-gray-800 mb-1.5">Title (optional)</label>
    <input type="text" name="title" id="{{ $prefix }}title" placeholder="Day 1 Reward"
        class="w-full px-3.5 py-2.5 rounded-[10px] text-[14px] outline-none dark:bg-[#1a1625] bg-white dark:text-white text-gray-800 dark:border dark:border-white/[0.1] border border-black/[0.1]">
</div>

<div>
    <label class="block text-[12px] font-bold dark:text-white text-gray-800 mb-1.5">Icon (emoji, optional)</label>
