 <aside id="sidebar"
     ...
     <nav class="flex-1 px-2.5 py-3 flex flex-col gap-0.5 overflow-y-auto">
         ...
         <a id="nav-dashboard" href="{{ route('admin.dashboard') }}"
           ...
           {{ request()->routeIs('admin.dashboard') ? 'text-orange-600 dark:text-orange-400 nav-active-dark' : 'text-gray-600 dark:text-gray-400' }}">
         ...
         <a id="nav-users" href="{{ route('admin.users.index') }}"
             class="nav-item flex items-center gap-2.5 px-3 py-[9px] rounded-[10px] text-[13.5px] font-semibold cursor-pointer no-underline transition-all duration-200
           {{ request()->routeIs('admin.users.index') ? 'text-orange-600 dark:text-orange-400 nav-active-dark' : 'text-gray-600 dark:text-gray-400' }}">
             <svg class="w-[17px] h-[17px] flex-shrink-0" fill="none" stroke="currentColor" stroke-width="2"
                 stroke-linecap="round" stroke-linejoin="round" viewBox="0 0 24 24">
                 <path d="M3 9l9-7 9 7v11a2 2 0 01-2 2H5a2 2 0 01-2-2z" />
                 <polyline points="9 22 9 12 15 12 15 22" />
         ...
         <a id="nav-tasks" href="#" onclick="setNav('tasks',event)"
